...
def search_image():
    ...
    try:
        ...
        try:
            ...
            # 找出最相似的圖像
            best_match_id, similarity_score = find_most_similar(query_vector, database_vectors)
            ...
            # 取得最相似圖像的詳細資訊
            best_match = db.query(Image).filter(Image.id == best_match_id).first()
...
if __name__ == '__main__':
    ...
    # 啟動 Flask 應用程式
    print("啟動 Flask 應用程式...")
    print("用戶搜尋頁面: http://127.0.0.1:5000/")
    print("管理員上傳頁面: http://127.0.0.1:5000/admin")
